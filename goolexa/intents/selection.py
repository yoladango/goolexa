...
from goolexa import ask, queue, app, api
from goolexa.utils.music import GMusicWrapper
...
@ask.intent("GoolexaPlayArtistIntent")
...
@ask.intent("GoolexaPlayAlbumIntent")
...
@ask.intent("GoolexaPlayThumbsUpIntent")
...
@ask.intent("GoolexaPlaySongIntent")
...
@ask.intent("GoolexaPlaySimilarSongsRadioIntent")
...
@ask.intent("GoolexaPlaySongRadioIntent")
...
@ask.intent("GoolexaPlayArtistRadioIntent")
...
@ask.intent("GoolexaPlayPlaylistIntent")
...
@ask.intent("GoolexaPlayIFLRadioIntent")
...
@ask.intent("GoolexaQueueSongIntent")
...
@ask.intent("GoolexaPlayDifferentAlbumIntent")
...
@ask.intent("GoolexaPlayLibraryIntent")
def play_library():
    if api.is_indexing():
        return statement(render_template("indexing"))
